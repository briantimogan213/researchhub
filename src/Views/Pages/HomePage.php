...
?>
  <div class="relative max-w-screen">
    ...
    <div class="flex-grow max-w-[600px] mx-auto">
      <div class="mx-auto flex flex-col justify-center items-center text-center my-1 lg:my-8 p-4">
        <h1 class="text-[20px] md:text-[24px] lg:text-[32px] font-[Poppins] font-[600] text-[#16507B] lg:text-nowrap lg:whitespace-nowrap">Where Knowledge Meets Innovation</h1>
      </div>
    </div>
  </div>
