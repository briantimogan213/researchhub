...
export function TextArea({ label, name, placeholder = "", className = "", labelColor = "text-white", ...props }: { label: string, name: string, placeholder?: string, className?: string, labelColor?: string, } & React.TextareaHTMLAttributes<HTMLTextAreaElement> ) {
  return (
    <div className={
      clsx(
        "flex flex-col justify-start w-full",
