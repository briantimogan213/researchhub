...
import { React, ReactDOM, ReactPlayerYoutube, parseMarkup, pathname } from './imports';
      ...
      <div className="grid grid-cols-1">
        ...
        {!isLoading && data.length > 0 && (
          data.map((thesis: { title: string, views: number, id: number|string }, i: number) => (
            <div onClick={() => handleView(thesis as any)} key={"thesis_" + i + "_" + thesis.id} className="py-4 px-2 cursor-pointer hover:*:text-blue-500 border-gray-200 flex flex-nowrap justify-between items-center">
