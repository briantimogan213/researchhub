...
import { React, ReactDOM, clsx, pathname } from '../imports';
import { NavItems } from '../types';

function SidebarNav({ defaultShow = true, sidebarList, toggleBtn }: { defaultShow?: boolean, sidebarList: NavItems[], toggleBtn: HTMLButtonElement }) {
