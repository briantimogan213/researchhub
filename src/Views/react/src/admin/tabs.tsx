...
export function Tab({ tabKey, children }: { tabKey: string, children: React.ReactNode }) {
...
export function Tabs({ tabs = [], children, ...props }: { tabs: TabLabel[], children: React.ReactNode }) {
