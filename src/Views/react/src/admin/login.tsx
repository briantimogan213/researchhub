      ...
      <div className="w-full pt-16 relative">
        ...
        <div className="p-4">
          <form onSubmit={onLogin} className="max-w-md mx-auto flex flex-col gap-8 border border-sky-300 rounded-lg p-8 shadow-lg pt-10">
            ...
            <div>
              <a href={pathname("/login")} className="text-sky-500 hover:text-sky-300 hover:underline pl-4">Login as Student?</a>
              <a href={pathname("/teacher/login")} className="text-sky-500 hover:text-sky-300 hover:underline pl-4">Login as Teacher?</a>
            </div>
          </form>
        </div>
      </div>
